...
public class Tabellliste {
	...
	public static void main(String[] args) {
		...
		// Tester om ordListe2 er en undermengde av OrdListe1
		System.out.println("Er ordliste2 en undermengde av ordliste1? :\n"+ordListe1.undermengde(ordListe2));
	}
